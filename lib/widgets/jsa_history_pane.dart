...
import '../screens/jsa_screen.dart';
import '../services/job_storage_service.dart';
import '../services/jsa_export_service.dart';
import '../services/jsa_storage_service.dart';

class JsaHistoryPane extends StatefulWidget {
  const JsaHistoryPane({
    super.key,
    this.onOpenDraft,
  });

  final Future<void> Function(JsaDraft draft)? onOpenDraft;

  @override
  State<JsaHistoryPane> createState() => _JsaHistoryPaneState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color: complete ? Colors.green.shade300 : colorScheme.primary,
