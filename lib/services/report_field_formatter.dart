...
class ReportFieldMeta {
  ...
  String labelFor(String company, {bool email = false}) {
    ...
    if (company == 'Continental' && continentalLabel != null) {
      return continentalLabel!;
    }
    return label;
  }
}
...
class ReportFieldFormatter {
  static const Map<String, ReportFieldMeta> meta = {
    'tbg': ReportFieldMeta(
        key: 'tbg', label: 'TBG', emailLabel: 'Tubing Pressure', unit: 'psi'),
    'csg': ReportFieldMeta(
        key: 'csg', label: 'CSG', emailLabel: 'Casing Pressure', unit: 'psi'),
    'icp': ReportFieldMeta(key: 'icp', label: 'ICP', unit: 'psi'),
    'scp': ReportFieldMeta(key: 'scp', label: 'SCP', unit: 'psi'),
    'choke': ReportFieldMeta(
        key: 'choke',
        label: 'Chk',
        machLabel: 'Choke',
        emailLabel: 'Choke',
        unit: ''),
    'waterRate': ReportFieldMeta(
        key: 'waterRate',
        label: 'H2O',
        machLabel: 'Water/hr',
        emailLabel: 'Water Rate',
        unit: 'bbls/hr'),
    'oilRate': ReportFieldMeta(
    ...
    'diff': ReportFieldMeta(
        key: 'diff', label: 'Diff', emailLabel: 'Differential', unit: '"'),
    'sp': ReportFieldMeta(
        key: 'sp', label: 'SP', emailLabel: 'Separator Pressure', unit: 'psi'),
    'gasTemp': ReportFieldMeta(
        key: 'gasTemp', label: 'Gas TMP', emailLabel: 'Gas Temp', unit: '°'),
    'whTemp': ReportFieldMeta(
        key: 'whTemp', label: 'WH TMP', emailLabel: 'Wellhead Temp', unit: '°'),
    'waterTemp': ReportFieldMeta(
        key: 'waterTemp',
        label: 'H2O TMP',
        emailLabel: 'Water Temp',
        unit: '°'),
    'prop': ReportFieldMeta(
        key: 'prop', label: 'Prop', emailLabel: 'Prop Rate', unit: 'gal/hr'),
    'biocide': ReportFieldMeta(
        key: 'biocide',
        label: 'Biocide',
  ...
  static String labelFor(ReportField field, String company,
      {bool email = false}) {
