...
class ReportProfileService {
  ...
  static const List<ReportField> availableFields = [
    ...
    ReportField(key: 'waterGaugeText', label: 'WATER TANK READINGS'),
    ReportField(key: 'oilGaugeText', label: 'OIL TANK READINGS'),
    ReportField(key: 'diff', label: 'DIFF'),
    ReportField(key: 'stat', label: 'STAT'),
    ReportField(key: 'temp', label: 'TEMP'),
    ReportField(key: 'gasCoolerInTemp', label: 'GAS IN TEMP'),
    ReportField(key: 'gasCoolerOutTemp', label: 'GAS OUT TEMP'),
    ReportField(key: 'gasCoolingDelta', label: 'GAS COOLING DELTA'),
    ReportField(key: 'waterCoolerInTemp', label: 'WATER IN TEMP'),
    ReportField(key: 'waterCoolerOutTemp', label: 'WATER OUT TEMP'),
    ReportField(key: 'waterCoolingDelta', label: 'WATER COOLING DELTA'),
